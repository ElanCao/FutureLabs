...
function SignInForm() {
  ...
  useEffect(() => {
    getProviders().then((p) => {
      if (p) {
        const names = Object.keys(p).filter((k) => k !== "credentials");
          ...
          <div className="space-y-2 mb-6">
            {oauthProviders.includes("github") && (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white font-medium py-3 rounded-xl transition-colors"
              >
          ...
          {mode === "register" && (
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-900 border border-gray-700 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 focus:border-violet-500 outline-none transition-colors"
              />
            </div>
          )}
          <div>
