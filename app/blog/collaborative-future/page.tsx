      ...
      <section className="py-16 bg-indigo-600 text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-balance">
            Build the collaborative future
          </h2>
          <p className="mt-3 text-indigo-200 text-lg text-balance">
            Join the waitlist and be part of the human-AI collaboration platform.
          </p>
          <div className="mt-6 max-w-md mx-auto">
            <WaitlistSignup variant="inline" page="blog-collaborative-future" />
          </div>
        </div>
      </section>
    </>
